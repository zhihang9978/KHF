...
public class DatabaseMigrationHint extends FrameLayout {
    ...
    public DatabaseMigrationHint(Context context, int currentAccount) {
        ...
        title.setText(LocaleController.getString(R.string.OptimizingApp));
        ...
        description1.setText(LocaleController.getString(R.string.OptimizingAppDescription1));
        ...
        description2.setText(LocaleController.getString(R.string.OptimizingAppDescription2));
