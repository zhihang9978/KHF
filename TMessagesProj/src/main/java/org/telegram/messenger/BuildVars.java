...
public class BuildVars {
    ...
    public static int APP_ID = 30258485;
    public static String APP_HASH = "EF83219F9349C72045FF81566dd92C74";

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = "";
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=com.rivermint.pulsechat";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "com.rivermint.pulsechat.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
