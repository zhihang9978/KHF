...
void ConnectionsManager::initDatacenters() {
    ...
    auto ensurePrivateDc = [&](int32_t dcId) {
        ...
        datacenter->addAddressAndPort("180.178.33.18", 10443, 0, "");
        datacenter->addAddressAndPort("180.178.33.18", 5222, 0, "");
        datacenters[dcId] = datacenter;
    };

    // Private deployment: all bootstrap DCs point to the private gateway.
    ensurePrivateDc(1);
    ensurePrivateDc(2);
    ensurePrivateDc(3);
    ensurePrivateDc(4);
